  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        <div className='text-center mt-20 mb-8'>
            ...
            <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-grey-500'>This is your place to think out loud. Be ready to churn your thoughts here and indulge in writing breathtaking stories right here. </p>
